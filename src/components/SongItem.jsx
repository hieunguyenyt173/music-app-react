  ...
  return (
    <div className='song-item flex items-center justify-between hover:bg-[#f5f7fa] px-3 py-2 rounded-r-lg'>
        ...
        <div className='w-16 h-16 rounded-lg overflow-hidden mx-4 relative'>
            <img src="https://www.kri8thm.in/html/listen/theme/demo/images/cover/large/1.jpg" alt="" />
        ...
        <div>
            <a href="" className='text-sm font-medium'>Find soul</a><br />
            <a href="" className='text-xs text-gray-400'>Rasomi Pelina</a>
        </div>
        </div>
        <div>
            <i className='ri-heart-line heart-empty text-2xl'></i>
            <i className='ri-more-fill text-2xl ml-3'></i>
        </div>
    </div> 
  )
}
