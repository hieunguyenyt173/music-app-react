...
function Register() {
  return (
    ...
    <h1 class="text-3xl font-semibold text-center  dark:text-white heading  text-sky-600">Đăng ký</h1>

    <form class="mt-6">
        <div>
            <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">Tên tài khoản</label>
        ...
        <div class="mt-4">
            <div class="flex items-center justify-between">
                <label for="password" class="block text-sm text-gray-800 dark:text-gray-200">Mật khẩu</label>
        ...
        <div class="mt-4">
            <div class="flex items-center justify-between">
                <label for="password" class="block text-sm text-gray-800 dark:text-gray-200">Xác nhận mật khẩu</label>
    ...
    <div class="flex items-center mt-6 -mx-2">
        <button type="button" class="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
            ...
            <span class="hidden mx-2 sm:inline">Đăng nhập với Google</span>
        </button>
    ...
    <p class="mt-8 text-xs font-light text-center text-gray-400"> Đã có có tài khoản? <a href="#" class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Đăng nhập</a></p>
</div>
    </div>
  )
}
