...
function Login() {
  return (
    ...
    <h1 class="text-3xl font-semibold text-center dark:text-white heading  text-sky-600">Đăng nhập</h1>
    ...
    <form class="mt-6">
        ...
        <div class="mt-4">
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-gray-600 dark:text-gray-400 hover:underline">Quên mật khẩu?</a>
            </div>
    ...
    <p class="mt-8 text-xs font-light text-center text-gray-400"> Chưa có tài khoản? <a href="#" class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Đăng ký</a></p>
</div>
    </div>
  )
}
